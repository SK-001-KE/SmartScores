...
const FILES_TO_CACHE=[
  "./","./index.html","./about.html","./app.js","./manifest.json",
...
self.addEventListener("fetch",e=>{
  e.respondWith(caches.match(e.request).then(r=>r||fetch(e.request).then(res=>caches.open(CACHE_NAME).then(c=>{c.put(e.request.url,res.clone()); return res;}))).catch(()=>caches.match("./index.html")));
});
